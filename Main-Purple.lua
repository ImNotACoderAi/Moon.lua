...
function Moon.CreateLib(themes)
	...
	do
		...
		lib["2"]["BackgroundColor3"] = Color3.fromRGB(29, 23, 34);
	...
	function lib.Tab(options)
		...
		do
			...
			Tab["9"]["BackgroundColor3"] = Color3.fromRGB(38, 35, 47);
			Tab["9"]["TextSize"] = 14;
		...
		function Tab.Button(options)
			...
			do
				...
				Button["15"]["BackgroundColor3"] = Color3.fromRGB(38, 35, 47);
			...
			do
				Button["15"].MouseEnter:Connect(function()
					...
					Moon.tween(ti, Button["15"], {BackgroundColor3 = Color3.fromRGB(51, 48, 58)})
				...
				Button["15"].MouseLeave:Connect(function()
					...
					Moon.tween(ti, Button["15"], {BackgroundColor3 = Color3.fromRGB(38, 35, 47)})
		...
		function Tab.Toggle(options)
			...
			do
				...
				Toggle["1c"]["BackgroundColor3"] = Color3.fromRGB(38, 35, 47);
			...
			do
				function Toggle:ChangeState(b)
					...
					if Toggle.State then
						Moon.tween(ti, Toggle["20"], {BackgroundColor3 = Color3.fromRGB(146, 136, 184)})
						Moon.tween(ti, Toggle["22"], {ImageTransparency = 0})
					else
						Moon.tween(ti, Toggle["20"], {BackgroundColor3 = Color3.fromRGB(26, 18, 34)})
				...
				Toggle["1c"].MouseEnter:Connect(function()
					...
					Moon.tween(ti, Toggle["1c"], {BackgroundColor3 = Color3.fromRGB(51, 48, 58)})
					Moon.tween(ti, Toggle["1e"], {TextColor3 = Color3.fromRGB(255, 255, 255)})
					if Toggle.State == true then
						Moon.tween(ti, Toggle["20"], {BackgroundColor3 = Color3.fromRGB(146, 136, 184)})
					else
						Moon.tween(ti, Toggle["20"], {BackgroundColor3 = Color3.fromRGB(47, 43, 57)})
					end
				end)
				...
				input.InputEnded:Connect(function(input)
					...
					if input.UserInputType == Enum.UserInputType.MouseButton1 then
						...
						if Toggle.Hover then
							...
							Moon.tween(ti, Toggle["1c"], {BackgroundColor3 = Color3.fromRGB(38, 35, 47)})
							Moon.tween(ti, Toggle["1e"], {TextColor3 = Color3.fromRGB(220, 220, 220)})
						end
					end
				end)
		...
		function Tab.Label(options)
			...
			do
				...
				Label["23"].MouseEnter:Connect(function()
					Moon.tween(ti, Label["23"], {BackgroundColor3 = Color3.fromRGB(51, 48, 58)})
					Moon.tween(ti, Label["25"], {TextColor3 = Color3.fromRGB(255, 255, 255)})
				end)

				Label["23"].MouseLeave:Connect(function()
					Moon.tween(ti, Label["23"], {BackgroundColor3 = Color3.fromRGB(38, 35, 47)})
		...
		function Tab.Slider(options)
			...
			do
				...
				Slider["29"]["BackgroundColor3"] = Color3.fromRGB(38, 35, 47);
			...
			do
				Slider["29"].MouseEnter:Connect(function()
					Slider.Hover = true
					Sliderdrag = true
					Moon.tween(ti, Slider["30"], {BackgroundColor3 = Color3.fromRGB(92, 86, 99)})
					Moon.tween(ti, Slider["23"], {BackgroundColor3 = Color3.fromRGB(45, 32, 56)})
					Moon.tween(ti, Slider["29"], {BackgroundColor3 = Color3.fromRGB(51, 48, 58)})
				...
				Slider["29"].MouseLeave:Connect(function()
					...
					if not Slider.MouseDown then
						Moon.tween(ti, Slider["30"], {BackgroundColor3 = Color3.fromRGB(74, 64, 80)})
						Moon.tween(ti, Slider["23"], {BackgroundColor3 = Color3.fromRGB(28, 15, 34)})
						Moon.tween(ti, Slider["29"], {BackgroundColor3 = Color3.fromRGB(38, 35, 47)})
					end
				end)
				...
				input.InputBegan:Connect(function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 and Slider.Hover then
						...
						Moon.tween(ti, Slider["29"], {BackgroundColor3 = Color3.fromRGB(128, 126, 140)})
		...
		function Tab.Dropdown(options)
			...
			do
				...
				Dropdown["32"]["BackgroundColor3"] = Color3.fromRGB(38, 35, 47);
			...
			do
				function Dropdown.Add(id, value, call, options)
					...
					do
						...
						Dropdown.Items[id].instance["3a"]["BackgroundColor3"] = Color3.fromRGB(46, 38, 57);
					...
					Dropdown.Items[id].instance["3a"].MouseEnter:Connect(function()
						...
						Moon.tween(ti, Dropdown.Items[id].instance["3a"], {BackgroundColor3 = Color3.fromRGB(54, 50, 62)})
					end)
					...
					Dropdown.Items[id].instance["3a"].MouseLeave:Connect(function()
						...
						if not Item.MouseDown then
							Moon.tween(ti, Dropdown.Items[id].instance["3a"], {BackgroundColor3 = Color3.fromRGB(46, 38, 57)})
						end
					end)
			...
			do
				Dropdown["32"].MouseEnter:Connect(function()
					...
					if not Dropdown.Open then
						Moon.tween(ti, Dropdown["32"], {BackgroundColor3 = Color3.fromRGB(51, 48, 58)})
					else
						Moon.tween(ti, Dropdown["32"], {BackgroundColor3 = Color3.fromRGB(38, 35, 47)})
					end
				end)
	...
	function lib.Notify(options)
		...
		Notify["45"]["BackgroundColor3"] = Color3.fromRGB(29, 23, 34);
		...
		do
			...
			Moon.tween(ti, Notify["45"], {BackgroundTransparency = 0.2})
			wait(0.3)
